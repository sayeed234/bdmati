...
<h3 class="text-center text-success">{{ Session::get('successmessage') }}</h3>
    ...
    <form class="form-login" method="post" action="{{url('/register')}}">
      {{ csrf_field() }}
         ...
         <br>
          ...
          <div class="copywrite text-center" style="font-size: 12px;margin-top: 15px;">
             ...
             <div class="col-md-4"></div>
              <div class="col-md-2"><a href="{{url('/')}}"><button class="btn btn-sm btn-primary btn-block">Home</button></a></div>
              <div class="col-md-2"><a href="{{url('/login')}}"><button class="btn btn-block btn-sm btn-primary">Login</button></a></div>
              <div class="col-md-4"></div>
             </div>
