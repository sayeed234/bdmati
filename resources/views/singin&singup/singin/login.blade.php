      ...
      {{ csrf_field() }}
        ...
        <div class="text-center" style="margin-top:-60px;">
             ...
             <div class="col-md-4"></div>
              <div class="col-md-2 col-6"><a href="{{url('/')}}"><button class="btn btn-sm btn-primary btn-block">Home</button></a></div>
              <div class="col-md-2 col-6"><a href="{{url('/register')}}"><button class="btn btn-block btn-sm btn-primary">Register</button></a></div>
              <div class="col-md-4"></div>
             </div>
